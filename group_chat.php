...
<head>
    ...
    <title>Grupa | <?php echo htmlspecialchars($group['name']); ?></title>
...
<div class="group-container">
    ...
    <div class="chat-header">
        <div style="display: flex; align-items: center;">
            ...
            <?php if ($is_ghost): ?> <span style="background:rgba(108,92,231,0.2);color:#6c5ce7;padding:2px 8px;border-radius:10px;font-size:10px;margin-left:10px;">GHOST</span> <?php endif; ?>
        </div>
        <a href="dashboard.php" style="color: var(--text-muted); text-decoration: none; font-size: 24px;">&times;</a>
    </div>

    <!-- 2. OMOTAČ (SIDEBAR + PORUKE) -->
