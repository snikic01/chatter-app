...
try {
    ...
    // --- POPRAVLJENO: OŽIVLJAVANJE LAMPICA — ODMAH OSVEŽAVAMO LAST_SEEN KORISNIKA ---
    if ($user_id > 0) {
    ...
    // Unifikujemo varijable za sve privatne podfajlove radi stopostotne kompatibilnosti
    $my_id = $user_id;
    ...
    // Rutiranje ka fajlovima unutar private-actions foldera (Korišćenjem require_once kao u grupama)
    switch ($action) {
        case 'list':
